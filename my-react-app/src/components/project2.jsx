...
function Project2(){
    ...
    <div className="project2_container">
        ...
        <br /> 
        <h2 className="heading">Flexbox Project</h2>
        ...
        <br />
        <p classname="paragraph"><span className="github_repo">Github repository:</span> https://github.com/tildanyrvik/flexbox-practice.git</p>
        </p>
    </div>
    )
}
